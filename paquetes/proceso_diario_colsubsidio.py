...
def descarga_url_productos():
	...
	def obtiene_urls_producto(navegador, url, tiempo_espera_scroll=2):
		...
		try:
			...
			print('-'*50)
			print('No se pudo procesar: df_prods = obtiene_data_producto_de_cat(navegador)')
...
print('Descargando URLs de categorias...')
descarga_url_categorias()
print('Descargando URLs de productos...')
descarga_url_productos()